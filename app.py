...
def page_home():
    ...
    demo_images = [
        ("smartvision_dataset/detection/images/image_000020.jpg",
         ...
         "📷 Demo 1: Street Scene"),
        ("smartvision_dataset/detection/images/image_000035.jpg",
         "smartvision_dataset/detection/labels/image_000035.txt",
         "📷 Demo 2: Restaurant Scene"),
        ("smartvision_dataset/detection/images/image_000040.jpg",
         "smartvision_dataset/detection/labels/image_000040.txt",
